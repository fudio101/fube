...
--
-- Name: fube; Type: DATABASE; Schema: -; Owner: postgres
--
DROP DATABASE fube;

CREATE DATABASE fube WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_US.UTF-8' LC_CTYPE = 'en_US.UTF-8';


ALTER DATABASE fube OWNER TO postgres;
